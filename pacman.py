...
def runGames(layout, pacman, ghosts, display, num_games, record, numTraining=0, catchExceptions=False, timeout=30):
    # import __main__
    ...
    for i in range(num_games):
        ...
        game = rules.newGame(layout, pacman, ghosts,
                             gameDisplay, training, catchExceptions)
        game.run()
